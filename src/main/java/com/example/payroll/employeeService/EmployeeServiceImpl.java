...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    public ResponseEntity<?> newEmployee(EmployeeDTO newEmployee) {
        ...
        User user = userRepository.findByUsername(newEmployee.getEmail())
                .orElseThrow(() -> new ResourceNotFoundException("User with email "+newEmployee.getEmail()+" not found. Please register the user first."));

        Employee employee = EmployeeMapper.toEntity(newEmployee, dep);
        employee.setUser(user); // Set the user
